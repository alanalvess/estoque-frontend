...
interface SearchBarMarcaProps {
    onSearch: (marcas: Marca[], tipoBusca: 'nome' | 'todos') => void;
    onClear: () => void;
}

function SearchBarMarca({onSearch, onClear}: SearchBarMarcaProps) {
    ...
    async function handleSearch() {
        ...
        try {
            ...
            await buscar(`/marcas/buscar/${encodeURIComponent(query)}`, setMarcas, authHeaders);
            onSearch(marcas, 'nome');
            ...
            if (error.toString().includes('400')) {
                ...
                ToastAlerta('Erro ao buscar marcas', Toast.Error);
            }
        }
    }
