            ...
            <div className="flex-1 flex flex-col items-center text-center space-y-6 max-w-xl mb-10 p-4 sm:p-10 lg:p-20 bg-gray-300 dark:bg-gray-600 shadow-2xl rounded-2xl ">
                ...
                <div className="flex justify-center md:justify-start">
                    <Link to="/produtos/all">
                        <Button className="px-6 py-3 text-lg rounded-lg shadow-lg bg-rose-600 hover:bg-rose-700 dark:bg-teal-600 dark:hover:bg-teal-700 focus:ring-0 cursor-pointer">
                            Acessar Sistema
                        </Button>
                    </Link>
                </div>
